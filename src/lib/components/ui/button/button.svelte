<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				default: "bg-sage text-primary-foreground hover:bg-sage/80 [a]:hover:bg-sage/80",
				outline: "border-warm-gray bg-background hover:bg-sage-light hover:text-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 aria-expanded:bg-sage-light aria-expanded:text-foreground",
				secondary: "bg-sage-light text-secondary-foreground hover:bg-warm-gray aria-expanded:bg-sage-light aria-expanded:text-secondary-foreground",
				ghost: "hover:bg-sage-light hover:text-foreground dark:hover:bg-sage-light/20 aria-expanded:bg-sage-light aria-expanded:text-foreground",
